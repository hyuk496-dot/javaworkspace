...
public class D_Logical {
	 ...
	 * 
	 * AND && : a && b -> a와 b가 모두 참일 경우 true반환. a와 b 둘 중 하나라고 것짓일 경우 false
	 * 
	 * OR || : a || b -> a와 b둘 중 하나라도 참일경우 true, a와 b 둘 다 것진인 경우 false반환 ~한면서 => AND
	 * 또는 => OR
	 * 
	 */
	...
	public void method3() {
		...
		System.out.println("게속 진행하시려면 y를 입력해주세요 : ");
	...
	public void method4() {
		...
		// 뒤 쪽 조건들이 뭐든 무조건 false이기 때문에 뒤쪽 조건식은 실행자지
		// 않는다.
